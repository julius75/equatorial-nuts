...
class CreateOrderRawMaterialInventoryReviewsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('order_raw_material_inventory_reviews', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('order_raw_material_inventory_reviews');
    }
}
