    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
            <div class="symbol symbol-100 mr-5">
                <div class="symbol-label" style="background-image:url('{{asset('assets/media/svg/avatars/015-boy-6.svg')}}')"></div>
        ...
        <div>
            ...
            <div class="d-flex align-items-center bg-light-success rounded p-5 gutter-b">
                ...
                <div class="d-flex flex-column flex-grow-1 mr-2">
                    <h6 class="font-weight-normal text-dark-75 text-hover-primary font-size-lg mb-1">Coming soon</h6>
...
<!-------removed due to conflict with multiselect----------->
