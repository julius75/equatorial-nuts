                    ...
                    <div class="card-body p-0">
                        <div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
                            <div class="col-xl-12 col-xxl-10">
                                <!--begin::Wizard Form-->
                                <form class="form" id="kt_form" method="post" action="{{route('admin.app-regions.update', $region->id)}}">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-xl-9">
                                            ...
                                            <div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
                                                <h5 class="text-dark font-weight-bold">Edit Region's Details: {{$region->name}}</h5>
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">Region Name</label>
                                                    <div class="col-lg-9 col-xl-9">
                                                        <input class="form-control form-control-solid form-control-lg @error('name') is-invalid @enderror" value="{{ $region->name }}" id="name" name="name" type="text" required autocomplete="off"/>
                                                        @error('name')
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <select class="form-control form-control-lg form-control-solid county_id" id='sel_depart' name='county_id'>
                                                            <option selected value="{{$region->county->id}}" >{{$region->county->name}}</option>
                                                            <!-- Read Departments -->
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <select required class="form-control form-control-lg form-control-solid sub_county_id" id='sel_emp' name='sub_county_id' autocomplete="off">
                                                            <option selected value="{{$region->sub_county->id}}" >{{$region->sub_county->name}}</option>
