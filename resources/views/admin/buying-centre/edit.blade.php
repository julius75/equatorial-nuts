                                            ...
                                            <div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-9">
                                                        <input class="form-control form-control-solid form-control-lg @error('id_number') is-invalid @enderror" value="{{ $region->name }}" id="name" name="name" type="text" required autocomplete="off"/>
                                                        @error('name')
